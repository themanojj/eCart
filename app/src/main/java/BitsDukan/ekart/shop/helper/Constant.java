package BitsDukan.ekart.shop.helper;

import java.util.HashMap;

public class Constant {
    //MODIFICATION PART
    public static final String MAINBASEUrl = "https://bitsgalaxy.co/dukan/"; //Admin panel url

    //If you have eCart Website then place here website URL otherwise admin panel url
    public static final String WebsiteUrl = "https://bitsgalaxy.co/dukan/";

    //set your jwt secret key here...key must same in PHP and Android
    public static final String JWT_KEY = "eyJhbGciOiJIUzI1NiJ9.eyJSb2xlIjoiQWRtaW4iLCJJc3N1ZXIiOiJJc3N1ZXIiLCJVc2VybmFtZSI6Im1hbm9qIiwiZXhwIjoxNjMxMDIwMDU5LCJpYXQiOjE2MzEwMjAwNTl9.pv-k_wUqpiBY2vlKarmvOLtwuYymao9D10KrtYF6sMc";
